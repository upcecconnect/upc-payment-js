...
var e = class {
	...
	pay(e) {
		...
		if (this.setMessageListener(), a.setAttribute("frameborder", "0"), a.style.width = "100%", a.style.height = "100%", a.style.minHeight = "500px", a.id = "upc-payment-iframe", this.mode === "PaymentIframe") n.appendChild(a);
		else {
		...
		a.contentWindow?.document.body.appendChild(t), t.submit();
	}
	...
	validatePaymentData(e) {
		if (e.altTotalAmountCents && (typeof e.altTotalAmountCents != "number" || Number.isNaN(e.altTotalAmountCents))) throw Error("Field \"payment.altTotalAmountCents\" is invalid");
		...
		if (e.altFeeCents && typeof e.altFeeCents != "number") throw Error("Field \"payment.altFeeCents\" is invalid");
		if (typeof e.currencyNumericCode != "string" || !e.currencyNumericCode) throw Error("Field \"payment.currencyNumericCode\" is invalid");
		if (e.delay && (typeof e.delay != "number" || Number.isNaN(e.delay))) throw Error("Field \"payment.delay\" is invalid");
		if (typeof e.description != "string" || !e.description) throw Error("Field \"payment.description\" is invalid");
		if (e.feeCents && typeof e.feeCents != "number") throw Error("Field \"payment.feeCents\" is invalid");
		...
		if (e.url && typeof e.url != "string") throw Error("Payment locale is invalid");
	}
	getInputEl(e, t) {
	...
	setMessageListener() {
		let e = (e) => {
			if (e.data.from !== "UpcPaymentIframe") return;
			let t = () => {};
			...
			switch (n) {
				...
				case "TryAgain":
					...
					break;
				default:
					console.error(`Unknown message from iframe ${n}`);
					break;
			}
		};
